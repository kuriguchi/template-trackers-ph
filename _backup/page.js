    ...
    <main className="min-h-dvh bg-white text-[#1560a8]">
      ...
      <div className="mx-4 max-w-6xl mx-auto py-12 space-y-16">
        ...
        <header className="text-center px-4">
          ...
          <h1 className="mt-6 text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight leading-tight" style={{ color: "#0b4f78" }}>
          ...
          <div className="mt-8 pointer-events-none">
            <div className="hidden sm:block relative mx-auto w-72 h-40 opacity-30 blur-sm" style={{ background: "radial-gradient(circle at 20% 20%, #D3E3FD, transparent 25%), radial-gradient(circle at 80% 80%, #F0F4F9, transparent 25%)" }} />
          </div>
        </header>

        {/* About Section */}
        <section id="about" className="grid md:grid-cols-2 gap-6 items-center bg-white/60 rounded-2xl p-6 shadow-sm sm:no-border sm:no-shadow">
          <div>
            <h2 className="text-2xl font-bold" style={{ color: "#0b4f78" }}>We make planning simple</h2>
            <p className="mt-3 text-[#1560a8]/90">
              We make digital templates that simplify financial planning and empower you to manage your money intentionally — whether you’re budgeting for your family, business, or side hustle.
            </p>
        ...
        <section id="templates" className="space-y-6">
          <h3 className="text-2xl font-bold text-center" style={{ color: "#0b4f78" }}>Our Best Sellers</h3>
          
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { title: "Family Budget Planner", tag: "Monthly family budget", price: "₱199" },
              { title: "Freelancer Income Tracker", tag: "Track gigs & invoices", price: "₱149" },
              { title: "Business Expense Log", tag: "Simple expense monitoring", price: "₱249" },
            ].map((t) => (
              <div key={t.title} className="rounded-xl border p-4 bg-white/60 sm:m-4">
                ...
                <h4 className="font-semibold" style={{ color: "#0b4f78" }}>{t.title}</h4>
                <p className="text-sm text-[#1560a8]/80">{t.tag}</p>
                <div className="mt-4 flex items-center justify-between">
                  <div className="text-lg font-bold">{t.price}</div>
                  <button className="rounded-md bg-[#2596be] px-3 py-1 text-white text-sm font-medium">Add to Cart</button>
                </div>
              </div>
            ))}
          </div>
        ...
        <section id="how-it-works" className="rounded-2xl bg-[#f8fbff] p-6">
          <h3 className="text-2xl font-bold text-center" style={{ color: "#0b4f78" }}>How It Works</h3>
          <ol className="mt-6 space-y-4 max-w-3xl mx-auto text-[#1560a8]">
            <li className="flex items-start gap-4">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#2596be] text-white font-semibold">1</div>
              <div>
            ...
            <li className="flex items-start gap-4">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#2596be] text-white font-semibold">2</div>
              <div>
            ...
            <li className="flex items-start gap-4">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#2596be] text-white font-semibold">3</div>
              <div>
            ...
            <li className="flex items-start gap-4">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#2596be] text-white font-semibold">4</div>
              <div>
        ...
        <section className="space-y-4">
          <h3 className="text-2xl font-bold text-center" style={{ color: "#0b4f78" }}>What Our Users Are Saying</h3>
          <div className="grid md:grid-cols-3 gap-4">
            {[
              { name: "Ana (Manila)", text: "These templates helped me finally track my family budget. Simple and effective!" },
              { name: "Miguel (Cebu)", text: "Fast delivery and the sheets are easy to customize. Highly recommend." },
              { name: "Sara (Davao)", text: "Saved me so much time. Great for my small business bookkeeping." },
            ].map((r) => (
        ...
        <section className="rounded-2xl bg-white/70 p-6 flex flex-col items-center">
          <h4 className="text-xl font-bold" style={{ color: "#0b4f78" }}>Join our community of smart planners — get updates and exclusive offers.</h4>
          <form
            onSubmit={(e) => {
              e.preventDefault();
              // placeholder: no backend. Show basic client-side feedback.
          ...
          >
            ...
            />
            <button className="rounded-md bg-[#2596be] px-4 py-2 text-white font-semibold w-full sm:w-auto">Subscribe Now</button>
          </form>
        </section>
